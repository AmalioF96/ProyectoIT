        ...
        <script>
            $(document).ready(function () {
                $("input.cantidad").change(function () {
                    ...
                    var precio = parseFloat($("#precio-" + idProducto).text().replace(".","").replace(",","."));
                    var subtotal = cantidad * precio;
                    $("#subtotal-" + idProducto).text(subtotal.toLocaleString('de-DE', {minimumFractionDigits: 2}));
                    ...
                    $("#precioTotalCarrito").text(total.toLocaleString('de-DE', {minimumFractionDigits: 2}));
