...
<s:elseif test="listaReclamaciones==null">
    <s:action executeResult="true" name="listarDisputasResueltas">
...
<s:else>
    ...
    <html>
        <head>
            ...
            <title>Disputas Resueltas - UPOMediaMarket</title>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $("#reabrir").click(function () {
                        $(seleccionado).find("input[name='operacion']").val("reabrir");
                        if (confirm("Se reabrirá la disputa, ¿desea continuar?")) {
                            $(seleccionado).submit();
                        }
                    });
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button id="reabrir" class="btn btn-danger">Reabrir</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3">
                        <nav id="categorias" class="list-group make-me-sticky">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="list-group-item">
                                    <a href="/upomm/views/reclamaciones/resueltasAdmin.jsp" class="menu-link active">Disputas Resueltas</a>
                                </li>
                                <li class="list-group-item">
