                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <s:if test="%{producto!=null}">
                            <s:form id="formProducto" action="modificarProducto" method="post" enctype="multipart/form-data" theme="css_xhtml">   
                        </s:if>
                        <s:else>
                            <s:form id="formProducto" action="crearProducto" method="post" enctype="multipart/form-data" theme="css_xhtml">
                        </s:else>
